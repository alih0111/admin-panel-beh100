...
return(
  <>
   <form
    onSubmit={submitForm}
    className="absolute flex justify-center items-center flex-col mt-10 bg-slate-100 rounded-lg w-80 p-6 mx-auto"
  >
    ...
    <div className="flex gap-2">
      <button onClick={(e)=>{e.preventDefault(); setModalNum(2)}} className="bg-transparent text-slate-500 px-4 py-1 rounded-lg border border-slate-500">
        انصراف{" "}
      </button>{" "}
      <button
        type="submit"
